...
For more details on Hive replication and code samples refer [Apache Hive replication in Azure HDInsight clusters](https://docs.microsoft.com/en-us/azure/hdinsight/interactive-query/apache-hive-replication)
